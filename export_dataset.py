...
for i, data in enumerate(dataset):
    ...
    util.save_image(real_B_img, opt.output_dir + "heightmap_8bit_normalized{:0000d}.png".format(i))
    util.save_image(fake_A_img, opt.output_dir + "reliefmap_8bit{:0000d}.png".format(i))
